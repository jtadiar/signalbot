      ...
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <div style="background: #1f2937; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
          ...
          <ol style="color: #9ca3af; font-size: 14px; padding-left: 20px; margin: 0;">
            <li style="margin-bottom: 8px;">Download the app from <a href="https://github.com/c13studio/signalbot/releases/latest" style="color: #10b981;">our releases page</a></li>
