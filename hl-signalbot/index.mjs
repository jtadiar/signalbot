...
const CONFIG_PATH = process.env.CONFIG || new URL('./config/config.json', import.meta.url).pathname;
...
const STATE_PATH = process.env.STATE_PATH || new URL('./storage/state.json', import.meta.url).pathname;
